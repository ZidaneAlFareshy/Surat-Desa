			...
			<div class="col-md-12">
				<div class="card">
					...
					<form method="post" action="simpan-surat.php">
						...
						<br>
						<h6 class="container-fluid" align="right"><i class="fas fa-edit"></i> Formulir Informasi Orang Tua</h6><hr width="97%">
						<div class="row">
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Nama</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fnama_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Nama" required>
						           	</div>
						        </div>
						    </div>
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	<label class="col-sm-12" style="font-weight: 500;">Agama</label>
						           	<div class="col-sm-12">
						               	<input type="text" name="fagama_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Agama" required>
						           	</div>
						        </div>
						  	</div>
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="number" name="fnik_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan NIK" required>
						           	</div>
						        </div>
						  	</div>
						  	<div class="col-sm-6">
      							<div class="form-group">
           							<label class="col-sm-12" style="font-weight: 500;">Jenis Kelamin</label>
           							<div class="col-sm-12">
               							<select name="fjenis_kelamin_ortu" class="form-control" required>
						  	...
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="ftempat_lahir_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Tempat Lahir" required>
						           	</div>
						        </div>
						  	</div>
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="fpekerjaan_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Pekerjaan" required>
						           	</div>
						        </div>
						  	</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
      							<div class="form-group">
           							...
           							<div class="col-sm-12">
               							<input type="date" name="ftanggal_lahir_ortu" class="form-control" required>
           							</div>
       		 					</div>
  							</div>
						  	<div class="col-sm-6">
						      	<div class="form-group">
						           	...
						           	<div class="col-sm-12">
						               	<input type="text" name="falamat_ortu" class="form-control" style="text-transform: capitalize;" placeholder="Masukkan Alamat" required>
						           	</div>
						        </div>
						  	</div>
						</div>
