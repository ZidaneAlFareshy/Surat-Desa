      ...
      <div class="col-md-12">
        <div class="box box-default">
          <div class="box-header with-border">
            <h2 class="box-title"><i class="fas fa-envelope"></i> Konfirmasi Surat Pengantar Kelakuan Baik</h2>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    ...
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_spkb']; ?>" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
