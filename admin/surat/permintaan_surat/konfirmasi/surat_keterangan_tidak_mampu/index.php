<?php 
  ...
  $id = $_GET['id'];
  $qCek = mysqli_query($connect,"SELECT penduduk.*, surat_keterangan_tidak_mampu.* FROM penduduk LEFT JOIN surat_keterangan_tidak_mampu ON surat_keterangan_tidak_mampu.nik = penduduk.nik WHERE surat_keterangan_tidak_mampu.id_sktm='$id'");
            ...
            <form class="form-horizontal" method="post" action="update-konfirmasi.php">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="fnama_ortu" style="text-transform: uppercase;" value="<?php echo $row['nama_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Agama</label>
                      <div class="col-sm-9">
                        <input type="text" name="fagama_ortu" style="text-transform: capitalize;" value="<?php echo $row['agama_ortu']?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">NIK</label>
                      <div class="col-sm-9">
                        <input type="text" name="fnik_ortu" style="text-transform: uppercase;" value="<?php echo $row['nik_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Jenis Kelamin</label>
                      <div class="col-sm-9">
                        <input type="text" name="fjenis_kelamin_ortu" style="text-transform: uppercase;" value="<?php echo $row['jenis_kelamin_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tempat Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftempat_lahir_ortu" style="text-transform: uppercase;" value="<?php echo $row['tempat_lahir_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Pekerjaan</label>
                      <div class="col-sm-9">
                        <input type="text" name="fperkerjaan_ortu" style="text-transform: uppercase;" value="<?php echo $row['pekerjaan_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Tanggal Lahir</label>
                      <div class="col-sm-9">
                        <input type="text" name="ftanggal_lahir_ortu" style="text-transform: uppercase;" value="<?php echo $row['tanggal_lahir_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Alamat</label>
                      <div class="col-sm-9">
                        <input type="text" name="falamat_ortu" style="text-transform: uppercase;" value="<?php echo $row['alamat_ortu']; ?>" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="box-body pull-right">
                    <div>
                      <input type="hidden" name="id" value="<?php echo $row['id_sktm']; ?>" class="form-control">
                    </div>
