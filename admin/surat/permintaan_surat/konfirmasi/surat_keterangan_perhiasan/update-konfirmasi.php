<?php
	...
	$qUpdate 	= "UPDATE surat_keterangan_perhiasan SET no_surat='$no_surat', id_pejabat_desa='$id_pejabat_desa', status_surat='$status_surat', alasan_tolak='$alasan_tolak' WHERE id_skp='$id'";
