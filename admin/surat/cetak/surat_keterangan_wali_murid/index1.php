  	...
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_keterangan_wali_murid ON surat_keterangan_wali_murid.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_keterangan_wali_murid.id_pejabat_desa = '$id_pejabat_desa' AND surat_keterangan_wali_murid.id_skwm='$id'");
...
<div>
	<table width="100%">
		...
		<br>
		<div align="center"><u><h4 class="kop">Surat Keterangan Wali Murid</h4></u></div>
