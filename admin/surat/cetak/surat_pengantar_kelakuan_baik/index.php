<?php 
	include ('../../permintaan_surat/konfirmasi/part/akses.php');
  	...
  	$id = $_GET['id'];
  	$qCek = mysqli_query($connect,"SELECT penduduk.*, surat_pengantar_kelakuan_baik.* FROM penduduk LEFT JOIN surat_pengantar_kelakuan_baik ON surat_pengantar_kelakuan_baik.nik = penduduk.nik WHERE surat_pengantar_kelakuan_baik.id_spkb='$id'");
  	while($row = mysqli_fetch_array($qCek)){
        ...
        foreach($qTampilDesa as $rows){
			...
			$id_pejabat_desa = $row['id_pejabat_desa'];
		  	$qCekPejabatDesa = mysqli_query($connect,"SELECT pejabat_desa.jabatan, pejabat_desa.nama_pejabat_desa FROM pejabat_desa LEFT JOIN surat_pengantar_kelakuan_baik ON surat_pengantar_kelakuan_baik.id_pejabat_desa = pejabat_desa.id_pejabat_desa WHERE surat_pengantar_kelakuan_baik.id_pejabat_desa = '$id_pejabat_desa' AND surat_pengantar_kelakuan_baik.id_spkb='$id'");
...
<div>
	<table width="100%">
		<tr><img src="../../../../assets/img/logo-cirebon-90x90.png" alt="" class="logo" style="opacity: 50%;"></tr>
		...
		<br>
		<div align="center" style="padding-top: 20px;"><u><h3>SURAT PENGANTAR KELAKUAN BAIK</h3></u></div>
	...
	<div id="isi3">
		<table width="100%">
			<tr>
				<td class="indentasi">Yang bertanda tangan di bawah ini, <a style="text-transform: capitalize;"><?php echo $rowss['jabatan'] . " " . $rows['nama_desa']; ?>, Kecamatan <?php echo $rows['kecamatan']; ?>, <?php echo $rows['kota']; ?></a>, menerangkan bahwa :
				</td>
			</tr>
		</table>
		<br><br>
		<table width="100%" style="text-transform: capitalize;">
			...
			<tr>
				<td class="indentasi">Pendidikan Terakhir</td>
				<td>:</td>
		...
		<table width="100%">
			<tr>
				<td class="indentasi">Benar bahwa nama orang tersebut di atas adalah penduduk Desa kami, yang menurut sepengetahuan kami hingga sampai dikeluarkannya surat keterangan ini, yang bersangkutan di atas:</td>
			</tr>
			<tr>
				<td class="indentasi">a. Belum pernah dihukum berdasarkan vonis pengadilan yang berkekuatan tetap.</td>
			</tr>
			<tr>
				<td class="indentasi">b. Tidak sebagai tersangka dalam suatu tindak pidana, Baik tingkat penyidikan, Penuntutan umum maupun peradilan oleh lembaga yang berwenang.</td>
			</tr>
			<tr>
				<td>Surat keterangan ini diberikan untuk penyelesaian Administrasi Kepengurusan:</td>
			</tr>
		</table><br>
		<table width="100%" style="text-transform: capitalize;">
			<tr>
