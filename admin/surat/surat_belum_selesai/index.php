...
<div class="content-wrapper">
  ...
  <section class="content">      
    ...
    SELECT penduduk.nama, surat_keterangan.id_sk, surat_keterangan.no_surat, surat_keterangan.nik, login.whatsapp AS telepon, surat_keterangan.jenis_surat, surat_keterangan.status_surat, surat_keterangan.tanggal_surat 
    FROM penduduk 
    ...
    SELECT penduduk.nama, surat_keterangan_berkelakuan_baik.id_skbb AS id_sk, surat_keterangan_berkelakuan_baik.no_surat, surat_keterangan_berkelakuan_baik.nik, surat_keterangan_berkelakuan_baik.jenis_surat, login.whatsapp AS telepon, surat_keterangan_berkelakuan_baik.status_surat, surat_keterangan_berkelakuan_baik.tanggal_surat 
    FROM penduduk 
    ...
    SELECT penduduk.nama, surat_keterangan_domisili.id_skd AS id_sk, surat_keterangan_domisili.no_surat, surat_keterangan_domisili.nik, surat_keterangan_domisili.jenis_surat, login.whatsapp AS telepon, surat_keterangan_domisili.status_surat, surat_keterangan_domisili.tanggal_surat 
    FROM penduduk 
    ...
    SELECT penduduk.nama, surat_keterangan_perhiasan.id_skp AS id_sk, surat_keterangan_perhiasan.no_surat, surat_keterangan_perhiasan.nik, surat_keterangan_perhiasan.jenis_surat, login.whatsapp AS telepon, surat_keterangan_perhiasan.status_surat, surat_keterangan_perhiasan.tanggal_surat 
    FROM penduduk 
    ...
    SELECT penduduk.nama, surat_keterangan_usaha.id_sku AS id_sk, surat_keterangan_usaha.no_surat, surat_keterangan_usaha.nik, surat_keterangan_usaha.jenis_surat, login.whatsapp AS telepon, surat_keterangan_usaha.status_surat, surat_keterangan_usaha.tanggal_surat 
    FROM penduduk 
