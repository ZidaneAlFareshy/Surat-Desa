        ...
        <?php
          if(isset($_GET['filter']) && ! empty($_GET['filter'])){
            ...
            if($filter == '1'){
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rt, penduduk.rw, surat_lahir.no_surat, surat_lahir.tanggal_surat, surat_lahir.jenis_surat FROM penduduk LEFT JOIN surat_lahir ON surat_lahir.nik = penduduk.nik WHERE surat_lahir.status_surat='selesai'
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_lahir.no_surat, surat_lahir.tanggal_surat, surat_lahir.jenis_surat FROM penduduk LEFT JOIN surat_lahir ON surat_lahir.nik = penduduk.nik WHERE surat_lahir.status_surat='selesai' AND DATE(surat_lahir.tanggal_surat)='{$_GET['tanggal']}'
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_lahir.no_surat, surat_lahir.tanggal_surat, surat_lahir.jenis_surat FROM penduduk LEFT JOIN surat_lahir ON surat_lahir.nik = penduduk.nik WHERE surat_lahir.status_surat='selesai' AND MONTH(surat_lahir.tanggal_surat)='{$_GET['bulan']}' AND YEAR(surat_lahir.tanggal_surat)='{$_GET['tahun']}'
              ...
              UNION SELECT penduduk.nama, penduduk.dusun, penduduk.rw, penduduk.rt, surat_lahir.no_surat, surat_lahir.tanggal_surat, surat_lahir.jenis_surat FROM penduduk LEFT JOIN surat_lahir ON surat_lahir.nik = penduduk.nik WHERE surat_lahir.status_surat='selesai' AND YEAR(surat_lahir.tanggal_surat)='{$_GET['tahun']}'
