		          ...
		          <tbody>
		            <?php
		              ...
		              $qTampil = mysqli_query($connect, "SELECT penduduk.nama, surat_keterangan.* FROM penduduk LEFT JOIN surat_keterangan ON surat_keterangan.nik = penduduk.nik WHERE surat_keterangan.status_surat='pending' 
		                UNION SELECT penduduk.nama, surat_pengantar_kelakuan_baik.* FROM penduduk LEFT JOIN surat_pengantar_kelakuan_baik ON surat_pengantar_kelakuan_baik.nik = penduduk.nik WHERE surat_pengantar_kelakuan_baik.status_surat='pending'
		                ...
		                UNION SELECT penduduk.nama, surat_pengantar_kelakuan_baik.* FROM penduduk LEFT JOIN surat_pengantar_kelakuan_baik ON surat_pengantar_kelakuan_baik.nik = penduduk.nik WHERE surat_pengantar_kelakuan_baik.status_surat='selesai'
